...
app.set('views',__dirname +  '/views');//make layout available in everywhere
app.set('view engine', 'hbs') //the app knows that we're gonna use hbs as engine

//register partials, setting the partials
